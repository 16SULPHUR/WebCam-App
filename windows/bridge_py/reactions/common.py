...
def list_images(assets_dir: str) -> list[str]:
    """Meme/image assets, relative to assets_dir (the emoji cache is excluded)."""
    out: list[str] = []
...
def bundled_emoji(assets_dir: str) -> list[str]:
    emoji_dir = os.path.join(assets_dir, EMOJI_DIRNAME)
